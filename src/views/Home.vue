  ...
  <div class="home">
    ...
    <div class="landing-page">
        <div class="container">
            ...
            <div class="kiakia-navbar py-4">
                <div class="logo">
                    <a href="/"> <img src="@/assets/images/Layer 6.svg" alt="KiaKia-Glogo">
                    </a>
                </div>
                <div class="tabs">
                    <div class="menu-bar" @click="menubar()">
                        <i class="fa fa-bars fa-2x"></i>
                    </div>
                    <div class="menu-list">
                        <ul class="my-auto">
                            <li><a href="/about">About Us</a></li>
                            <li><a href="gaspreneur">Become a Gaspreneur</a></li>
                            <li><a href="#">Blog</a></li>
            ...
            <div class="row my-1">
                <div class="col-md-6 col-sm-12 ">
                    ...
                    <div class="mobileA">
                        ...
                        <div class="download">
                            <a href="#"> <img
                                    src="@/assets/images/kiakia gas (7)/Download Badge/Google Play Badge.png"
                                    alt="gplay">
                            </a>
                            <a class="me-3" href="#"> <img
                                    src="@/assets/images/kiakia gas (6)/Download Badge/App Store Badge.png"
                                    alt="apple">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="tank-info ms-5 mobileB">
                        <img src="@/assets/images/kiakia gas/Mobile/iPhone X.png" alt="tank info">
                    </div>
    ...
    <div class="container gas-monitor">
        <div class="row pt-5">
            <div class="col-md-6 col-sm-12 image">
                <img src="@/assets/images/Mock Creative.png" alt="gas Monitor">
            </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="gas-leakage">
                    <img src="@/assets/images/Group 45.png" alt="gas leakages">
    ...
    <div class="container image-mod">
        <div class="row pt-5">
            <div class="col-md-6 col-sm-12 gas-loan">
                <img src="@/assets/images/Mobile Mockup (1).png" alt="gas-loan">
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="gas-monitor">
            ...
            <div class="row pt-5">
                <div class="col-md-6 col-sm-12">
                    <div class="start">
                        ...
                        <img src="@/assets/images/kiakia gas (5)/Group 1777.png" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
    ...
    <div class="container  py-5">
        ...
        <div class="partners partners-desktop">
            <div><img src="@/assets/images/WhatsApp Image 2021-02-02 at 11.11 1.svg" alt="Partner5"></div>
            <div><img src="@/assets/images/WhatsApp Image 2021-02-02 at 11.12 1.svg" alt="Partner1"></div>
            <div><img src="@/assets/images/image 1.svg" alt="Partner2"></div>
            <div><img src="@/assets/images/Leap-Africa 1.svg" alt="Partner3"></div>
            <div><img src="@/assets/images//sahara 1.svg" alt="Partner4"></div>
        ...
        <div class="container">
            <div class="row pt-5">
                ...
                <div class="col-md-6 col-sm-12 cta mt-5">
                    <img src="@/assets/images/kiakia gas (4)/CTA/iPhone.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="footer ">
            <div class="footer-card">
                <img src="@/assets/images/Layer 6.svg" alt="logo">
            </div>
            <div class="footer-card">
    ...
    <div class="container mt-5 p-3" style="color: #969BAB;  border-top: 0.5px solid #888888;">
        &copy; Copyright, Gas360 {{ year }}. All right reserved
    </div>
    <!-- copyright -->
...
<style>
  ...
  * {
  ...
  .start-links .next-link {
    margin: 40px 0;
  }
  .start-links .link {
    color: var(--primary);
  }
  .start-links .next-link:hover {
    border-radius: 5px;
    background-color: var(--primary);
    padding: 10px 20px;
    transition: all 0.5s linear;
  }
  .start-links .next-link:hover .link {
    color: #fff;
  }
  /* ========================== partners========================= */
  .our-partners {
